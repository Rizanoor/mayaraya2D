<section class="h-100 w-100"
    ...
    <div class="container-xxl mx-auto p-0  position-relative header-2-1">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a href="{{ route('home') }}">
                <img style="margin-right: 0.75rem; width: 100px;" src="images/img_logo.png" alt=""
                    data-aos="fade-down" />
            </a>
                    ...
                    <div class="modal-content border-0" style="background-color: rgb(240, 176, 170) ;">
                        <div class="modal-header border-0" style="padding: 2rem; padding-bottom: 0">
                            <a href="{{ route('home') }}" class="modal-title" id="targetModalLabel">
                                <img style="margin-top: 0.5rem; width: 100px;" src="images/img_logo.png"
                                    alt="" />
                            </a>
                                ...
                                <ul class="navbar-nav ms-auto">
                                    <li class="nav-item dropdown">
                                        <a id="navbarDropdown" class="nav-link" href="#" role="button"
                                            ...
                                            Hai, {{ Auth::user()->name }} !
                                            <img src="{{ Storage::url('image/' . Auth::user()->photo) }}"
                                                class="rounded-circle user-photo w-15" alt=""
                                                style="max-height: 45px; border: 5px solid rgba(255, 255, 255, 0.25);"">
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                            <a href="#" class="dropdown-item"
                                                style="color:#5C2C8F; font-weight: 800;">3D</a>
