            ...
            <form style="margin-top: 1.5rem"
                ...
                <div class="content-4-1 d-flex flex-column align-items-center h-100 flex-lg-row"
                    ...
                    <div class="position-relative d-none d-lg-block h-100 width-left">
                        <img class="position-absolute img-fluid centered img-avatar" src="images/img_avatar.png"
                            alt="" />
                        <a href="https://readyplayer.me/avatar" class="btn btn-filll position-absolute btn-avatar">Ganti
                            avatar</a>
                    ...
                    <div class="d-flex mx-auto align-items-center justify-content-center width-right"
                        ...
                        <div class="right mx-lg-0">
                            <div class="align-items-center justify-content-center d-lg-none d-flex">
                                ...
                                <a href="https://readyplayer.me/avatar" target="_blank"
                            ...
                            <div style="margin-bottom: 1.75rem">
                                ...
                                <div class="d-flex w-100 border-bottom">
                                    <input class="input-field border-0 {{ $errors->has('name') ? 'is-invalid' : '' }}"
                            ...
                            <div style="margin-bottom: 1.75rem">
                                ...
                                <div class="d-flex w-100 border-bottom">
                                    <input class="input-field border-0 {{ $errors->has('email') ? 'is-invalid' : '' }}"
